    ...
    public class Sind
    {
        ...
        public static Sind FromString(string sindData)
        {
            ...
            var sind = new Sind
            {
                ...
                TaxPerformanceDate = parser.TryGetDate("DUZP", "Tax performance date"),
                TaxStatementDueDate = parser.TryGetDate("DPPD", "Tax statment due date"),
                DueDate = parser.TryGetDate("DT", "Due date"),
